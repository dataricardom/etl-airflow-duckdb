...
CONNECTION_DUCKDB = "motherduck_conn"  # minha connection ID da MotherDuck connection
CONNECTION_POSTGRESDB = "postgres_conn" # minha connection ID do PostgreSQL connection
